...
// import { ContextVariables, Game } from './model';
...
//   ctx.put(ContextVariables.REQUEST.toString(), {
//     body: {
//       player: { player: p4, name: 'Fred' },
//       color: Color.BLUE,
//       numPlayers: 3,
//     },
//   });
//   ctx.put(ContextVariables.RESPONSE.toString(), new TestResponse());
//   return ctx;
// };
...
// beforeEach(() => {
//   ctx = testContext();
//   game = ctx.get(ContextVariables.GAME.toString()) as Game;
...
//     const board = ctx.get(ContextVariables.RESPONSE.toString()) as TestResponse;
//     expect(board.resp).toBeTruthy();
//     expect(board.resp.spaces.length).toBe(100);
//   });
...
//     ctx.put(ContextVariables.ACTION.toString(), 'registerPlayer');
//     game.instance.players = ['Wilma', 'Shaggy', 'Fred'];
//     registrationChain.execute(ctx);
//     const message = ctx.get('errorMessage') as string;
...
//     ctx.put(ContextVariables.REQUEST.toString(), {
//       body: { player: active, color: Color.BLUE },
//     });
...
//     const p = game.instance.players[0];
//     ctx.put('activePlayer', p);
//     game.instance.activePlayer = p;
//     ctx.put(ContextVariables.REQUEST.toString(), {
//       body: { player: { player: p, name: 'Wilma' }, color: Color.GREEN },
//     });
...
//     ctx.put(ContextVariables.REQUEST.toString(), {
//       body: { player: player, color: Color.GREEN },
//     });
